    ...
    with open('donnees.json', 'r') as f:
        ...
        for i in contenu:
            for j in contenu[i]:
                if j['orgName'] == "CLOUDFLARENET":
                ...
                elif j['orgName'] == "GOOGLE" or j['orgName'] == "GOOGLE-CLOUD-PLATFORM" or j['orgName'] == "GOOGLE-FIBER":
                    nb_Google_server += 1
                ...
                elif j['orgName'].startswith("AMAZON"):
                    nb_amazon_server += 1
                    ...
                    nb_nextdns_server += 1
                    nb_nextdns_DoT += 1 if j['DoT'] == "Yes" and j['DoH'] == "No" else 0
                    nb_nextdns_DoH += 1 if j['DoH'] == "Yes" and j['DoT'] == "No" else 0
                    nb_nextdns_DoT_DoH += 1 if j['DoT'] == "Yes" and j['DoH'] == "Yes" else 0
                    nb_nextdns_non += 1 if j['DoT'] == "No" and j['DoH'] == "No" else 0



data = {
    'Categories': ['Cloudflare, Inc.', 'Google LLC', 'AT&T Corp.', 'Amazon Technologies Inc.', 'Level 3 Parent, LLC', 'Cisco OpenDNS, LLC', 'nextdns'], 
    'Nombre_server': [nb_Cloudflare_server,nb_Google_server,nb_atnt_server,nb_amazon_server,nb_level3_server,nb_cisco_server,nb_nextdns_server],
    'Percentages_DoT': [round(nb_Cloudflare_DoT/nb_Cloudflare_server*100,1),round(nb_Google_DoT/nb_Google_server*100,1),round(nb_atnt_DoT/nb_atnt_server*100,1),round(nb_amazon_DoT/nb_amazon_server*100,1),round(nb_level3_DoT/nb_level3_server*100,1),round(nb_cisco_DoT/nb_cisco_server*100,1),round(nb_nextdns_DoT/nb_nextdns_server*100,1)],
    'Percentages_DoH': [round(nb_Cloudflare_DoH/nb_Cloudflare_server*100,1),round(nb_Google_DoH/nb_Google_server*100,1),round(nb_atnt_DoH/nb_atnt_server*100,1),round(nb_amazon_DoH/nb_amazon_server*100,1),round(nb_level3_DoH/nb_level3_server*100,1),round(nb_cisco_DoH/nb_cisco_server*100,1),round(nb_nextdns_DoH/nb_nextdns_server*100,1)],
    'Percentages_DoT_DoH': [round(nb_Cloudflare_DoT_DoH/nb_Cloudflare_server*100,1),round(nb_Google_DoT_DoH/nb_Google_server*100,1),round(nb_atnt_DoT_DoH/nb_atnt_server*100,1),round(nb_amazon_DoT_DoH/nb_amazon_server*100,1),round(nb_level3_DoT_DoH/nb_level3_server*100,1),round(nb_cisco_DoT_DoH/nb_cisco_server*100,1),round(nb_nextdns_DoT_DoH/nb_nextdns_server*100,1)],
    'Percentages_non': [round(nb_Cloudflare_non/nb_Cloudflare_server*100,1),round(nb_Google_non/nb_Google_server*100,1),round(nb_atnt_non/nb_atnt_server*100,1),round(nb_amazon_non/nb_amazon_server*100,1),round(nb_level3_non/nb_level3_server*100,1),round(nb_cisco_non/nb_cisco_server*100,1),round(nb_nextdns_non/nb_nextdns_server*100,1)]
    }
