...
if __name__ == "__main__":
    ...
    with open('carte/edns/DoH/infos_resolveurs_DoH.json', 'r') as f:
        contenu = json.load(f)
        for i in contenu:
            for j in contenu[i]:
    ...
    <div style="position: fixed; bottom: 50px; left: 50px; width: 200px; background-color: rgba(255, 255, 255, 0.8); border-radius: 10px; box-shadow: 0px 0px 5px 0px rgba(0,0,0,0.75); z-index: 9999; font-family: Arial, sans-serif; font-size: 14px; padding: 10px;">
        ...
        <div style="margin-bottom: 5px;">
            <span style="display: inline-block; width: 12px; height: 12px; background-color: rgb(112, 173, 37) ; border-radius: 50%; margin-right: 5px;"></span> EDNS(0) RecommendedPadding
        </div>
        <div style="margin-bottom: 5px;">
    ...
    ma_carte.save('carte/edns/DoH/basic_map.html')